...
define('resources/select2',["require", "exports", "aurelia-framework", "bootstrap", "select2"], function (require, exports, aurelia_framework_1, bootstrap_1) {
    "use strict";
    var Select2CustomAttribute = (function () {
        ...
        Select2CustomAttribute.prototype.attached = function () {
            var _this = this;
            bootstrap_1.default(this.element).select2(this.value).on('change', function (evt) {
        ...
        Select2CustomAttribute.prototype.detached = function () {
            bootstrap_1.default(this.element).select2('destroy');
        };
...
define('views/widgets/inputs/form-datepicker',["require", "exports", "aurelia-framework", "bootstrap", "bootstrap-datepicker"], function (require, exports, aurelia_framework_1, bootstrap_1) {
    "use strict";
    var moment = require('moment');
    var FormDatepicker = (function () {
        function FormDatepicker(element) {
            this.format = 'yyyy-mm-dd';
            this.element = element;
        }
        FormDatepicker.prototype.attached = function () {
            var _this = this;
            bootstrap_1.default(this.element).find('.datepicker')
                .datepicker({
                format: this.format,
                ...
                _this.value = moment(e.date).format("YYYY-MM-DD");
            });
        };
    ...
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
    ], FormDatepicker.prototype, "format", void 0);
    FormDatepicker = __decorate([
        aurelia_framework_1.inject(Element),
        aurelia_framework_1.bindable('value'),
        __metadata("design:paramtypes", [Object])
    ], FormDatepicker);
...
define('text!views/widgets/inputs/form-datepicker.html', ['module'], function(module) { module.exports = "<template>\r\n    <require from=\"../../../css/bootstrap-datepicker3.css\"></require>\r\n    <input class=\"datepicker\" data-provide=\"datepicker\" value.bind=\"value\">\r\n</template>"; });
